...
//		cout << "<3> Diabetes test\n";
//		cout << "<4> Back to main menu\n\n";
//		cout << "--->\t";
//		cin >> disease;
//	} while (disease != 1 && disease != 2 && disease != 3 && disease != 4);
//
//	if (disease == 1)
//		hyperglycemia_test();
//	else if (disease == 2)
...
//	system("CLS");
//	int yes = 0;
//	cout << "hyperglycemia waiting to be done\n";
//}
//
...
//	system("CLS");
//	int yes = 0;
//	cout << "hypoglycemia waiting to be done\n";
//}
//
////diabetes test, if has the symptoms, yes +1, if yes > 3, u have diabetes
//void diabetes_test(void)
//{
//	system("CLS");
//	int yes = 0;
//	cout << "diabetes waiting to be done\n";
//}
//
//
//
